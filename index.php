...
<head>
    ...
    <link rel="icon" href="#">
    <title>Welcome to best restaurant</title>
    <!-- Bootstrap core CSS -->
...
<body class="home">
        ...
        <!-- banner part starts -->
        <section class="hero bg-image" data-image-src="images/picture/burger.jfif">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Welcome to Online Restaurant Management System</h1>
                    <h5 class="font-white space-xs">Find restaurants, specials, and deliver to where you are</h5>
                            ...
                            echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                    <div class="food-item-wrap">
                                        ...
                                        <div class="content">
                                            ...
                                            <button onclick="ingredient">Ingredient</button>
                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <p>We"ve got your covered with menus from many delivery restaurants online.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <p>We"ve got your covered with menus for many delivery restaurants online.</p>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="title-block pull-left">
                            <h4>Available restaurants</h4> </div>
                    </div>
                    <div class="col-sm-8">
                ...
                <div class="row top-footer">
                    ...
                    <div class="col-xs-12 col-sm-2 how-it-works-links color-gray">
                        ...
                        <ul>
                            ...
                            <li><a href="#">Pay via credit card or bank account</a> </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-5 additional-info color-gray">
                            ...
                            <div class="social-media">
                               ...
                               <a href="gmail"> <i class="fa fa-email"></i></a>
