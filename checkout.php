        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.html"> <img class="img-rounded" src="images/logo1.pnp" alt=""> </a>
                                    ...
                                    <div class="cart-totals margin-b-20">
                                        ...
                                        <div class="cart-totals-fields">
											...
											<tbody>
                                                    ...
                                                    <tr>
                                                        <td>Cart Subtotal</td>
                                                        <td> <?php echo $item_total."birr"; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Delivery </td>
                                                        <td>5 birr</td> 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-color"><strong> <?php echo $item_total."birr"+5; ?></strong></td>
                                                    </tr>
                                                </tbody>
                                        ...
                                        <ul class=" list-unstyled">
                                           <h3>Select Payment Options</h3> 
                                            <li>
                                                ...
                                                <input type="radio" id="opn1" name="option">Telebirr </input><br>
                                                <input type="radio" id="opn1" name="option">CBE birr </input><br>
                                                <input type="radio" id="opn1" name="option">HeloCash </input><br>
                                                <input type="radio" id="opn1" name="option">Amole </input>
                                            </li>
                                            <h4>Other Option </h4>
                                            <li>
